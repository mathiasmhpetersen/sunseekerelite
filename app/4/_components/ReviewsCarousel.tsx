...
// Real, existing reviews only (brief Section 10). Gen 1-relevant coverage
// prioritised first — the Fritidsmarkedet X5 test leads.
const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    title: "Sunseeker Elite X3: Ny robotplæneklipper-spiller – pengene værd?",
    author: "MereMobil.dk",
